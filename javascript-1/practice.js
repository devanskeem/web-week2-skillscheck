...
function oddChecker(num){
	if (num % 2 !== 0) return "the number is odd";
...
let doubled = myNumbers.map(function(val) {return val*2})
//////////////////PROBLEM 15////////////////////

// Now lets use .filter to only get the nubmer(s) greater than 100. Call the new array 'filtered'

let filtered = myNumbers.filter(function(val){return val > 100})
//////////////////PROBLEM 16////////////////////

// Next up, reduce to get the total of the array. call the new array 'total'

let total = myNumbers.reduce(function(total, element){return total += element})
...
let myNumbersIndex = []
myNumbers.forEach(function(){return })
myNumbers.forEach(function(element, index) {myNumbersIndex.push(index)})
//////////////////PROBLEM 18////////////////////
...
let forTheLoveOfGeorge = notGeorge.map(function(element, index){return element = "George"})
//////////////////PROBLEM 19////////////////////
...
let enemies = people.filter(function(val) {return (val.friend === false)})
//////////////////PROBLEM 20////////////////////
...
let totallyAwesome = people.reduce(function(total, element) {return total += element.awesomeLevel}, 0)
