...
// The profileImage key will return this url .

let me = {
    firstname: 'Devan',
    superHeroName: "Schemin' Skeem",
    homeTown: 'Logan, UT',
    superPowers: ['Genius', 'Mind Reading', 'Telekinisis'],
    superPowerXP: function(){return Math.floor(Math.random() * 100) + 1},
    profileImage: function(){return `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10)}.jpg`}
}
//////////////////Step 3////////////////////
